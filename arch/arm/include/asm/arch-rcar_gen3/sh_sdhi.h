/*
 * arch/arm/include/asm/arch-rcar_gen3/sh-sdhi.h
 *
 * SD/MMC driver for Renesas R-Car Gen3 ARM SoCs
 *
 * Copyright (C) 2015 Renesas Electronics Corporation
 *
 * This file is based on arch/arm/include/asm/arch-rmobile/sh_sdhi.h
 *
