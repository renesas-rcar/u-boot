...
static const u32 r8a779a0_unlock_regs[] = {
...
const struct sh_pfc_soc_info r8a779a0_pinmux_info = {
	...
	.ops = &pinmux_ops,
	/* PMMRn */
	.unlock_regs_table = r8a779a0_unlock_regs,
	.unlock_regs_size = ARRAY_SIZE(r8a779a0_unlock_regs),
	.writable_area = 0x1ff,
