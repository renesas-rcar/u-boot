...
#define CPU_ALL_GP(fn, sfx)	\
	PORT_GP_CFG_28(0, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_32(1, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_25(2, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_17(3, fn, sfx),	\
	PORT_GP_CFG_27(4, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_21(5, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_21(6, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_21(7, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_21(8, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE),	\
	PORT_GP_CFG_21(9, fn, sfx, SH_PFC_PIN_CFG_IO_VOLTAGE)
...
/* MOD_SEL2 */				/* 0 */		/* 1 */		/* 2 */		/* 3 */
#define MOD_SEL2_14_15		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C6_3)
#define MOD_SEL2_12_13		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C5_3)
#define MOD_SEL2_10_11		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C4_3)
#define MOD_SEL2_8_9		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C3_3)
#define MOD_SEL2_6_7		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C2_3)
#define MOD_SEL2_4_5		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C1_3)
#define MOD_SEL2_2_3		F_(0, 0)	F_(0, 0)	F_(0, 0)	FM(I2C0_3)
...
static const u16 pinmux_data[] = {
	...
	PINMUX_IPSR_GPSR(IP0SR2_11_8,	GP2_02),
	PINMUX_IPSR_GPSR(IP0SR2_11_8,	D3),

	PINMUX_IPSR_GPSR(IP0SR2_15_12,	GP2_03),
	PINMUX_IPSR_GPSR(IP0SR2_15_12,	D4),

	PINMUX_IPSR_GPSR(IP0SR2_19_16,	GP2_04),
	PINMUX_IPSR_GPSR(IP0SR2_19_16,	MSIOF4_RXD),
	PINMUX_IPSR_GPSR(IP0SR2_19_16,	D5),

	PINMUX_IPSR_GPSR(IP0SR2_23_20,	GP2_05),
	...
	PINMUX_IPSR_GPSR(IP0SR2_27_24,	GP2_06),
	...
	PINMUX_IPSR_GPSR(IP0SR2_31_28,	GP2_07),
	...
	/* IP1SR2 */
	PINMUX_IPSR_GPSR(IP1SR2_3_0,	GP2_08),
	...
	PINMUX_IPSR_GPSR(IP1SR2_7_4,	GP2_09),
...
/*
 * In V3U, i2c is a main function and does not connect to GPIO.
 * For this reason, I guess that i2c doesn't need to define in here
 */
#if 0
/* - I2C0 ------------------------------------------------------------------- */
...
static const u32 pinmux_unlock_regs[] = {
	0xe6058000, 0xe6050000, 0xe6050800,
	0xe6058800, 0xe6060000, 0xe6060800,
	0xe6068000, 0xe6068800, 0xe6069000,
	0xe6069800,
};
...
const struct sh_pfc_soc_info r8a779a0_pinmux_info = {
	...
	.ops = &pinmux_ops,
	/* PMMRn */
	.unlock_regs = pinmux_unlock_regs,
	.unlock_regs_size = ARRAY_SIZE(pinmux_unlock_regs),
	.writable_area = 0x1ff,
