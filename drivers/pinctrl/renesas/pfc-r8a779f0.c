...
#define IP0SR1_3_0	F_(0, 0)		FM(TCLK1)		FM(HSCK2)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_7_4	F_(0, 0)		FM(TCLK4)		FM(HRX2)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_11_8	F_(0, 0)		F_(0, 0)		FM(HTX2)		FM(MSIOF2_SS1)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_15_12	F_(0, 0)		FM(TCLK2)		FM(HCTS2_N)		FM(MSIOF2_SS2)		FM(CTS4_N)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_19_16	F_(0, 0)		FM(TCLK3)		FM(HRTS2_N)		FM(MSIOF2_SYNC)		FM(RTS4_N)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_23_20	F_(0, 0)		FM(MSIOF2_SCK)		FM(SCK4)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_27_24	F_(0, 0)		FM(MSIOF2_RXD)		FM(RX4)			F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR1_31_28	F_(0, 0)		FM(MSIOF2_TXD)		FM(TX4)			F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)

/* IP0SR4 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 - F */
#define IP0SR4_3_0	F_(0, 0)		FM(MSPI4SC)		F_(0, 0)		FM(TAUD0I2)		FM(TAUD0O2)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_7_4	F_(0, 0)		FM(MSPI4SI)		F_(0, 0)		FM(TAUD0I4)		FM(TAUD0O4)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_11_8	F_(0, 0)		FM(MSPI4SO_MSPI4DCS)	F_(0, 0)		FM(TAUD0I3)		FM(TAUD0O3)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_15_12	F_(0, 0)		FM(MSPI4CSS1)		F_(0, 0)		FM(TAUD0I6)		FM(TAUD0O6)	FM(MSPI5SO_MSPI5DCS)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_19_16	F_(0, 0)		FM(MSPI4CSS0)		FM(MSPI4SSI_N)		FM(TAUD0I5)		FM(TAUD0O5)	FM(MSPI5SC)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_23_20	F_(0, 0)		FM(MSPI4CSS3)		F_(0, 0)		FM(TAUD0I8)		FM(TAUD0O8)	FM(MSPI5SSI_N)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_27_24	F_(0, 0)		FM(MSPI4CSS2)		F_(0, 0)		FM(TAUD0I7)		FM(TAUD0O7)	FM(MSPI5SI)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_31_28	F_(0, 0)		FM(MSPI4CSS5)		F_(0, 0)		FM(TAUD0I10)		FM(TAUD0O10)	FM(MSPI5CSS1)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP1SR4 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 - F */
#define IP1SR4_3_0	F_(0, 0)		FM(MSPI4CSS4)		F_(0, 0)		FM(TAUD0I9)		FM(TAUD0O9)	FM(MSPI5CSS0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_7_4	F_(0, 0)		FM(MSPI4CSS7)		F_(0, 0)		FM(TAUD0I12)		FM(TAUD0O12)	FM(MSPI5CSS3)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_11_8	F_(0, 0)		FM(MSPI4CSS6)		F_(0, 0)		FM(TAUD0I11)		FM(TAUD0O11)	FM(MSPI5CSS2)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_15_12	F_(0, 0)		FM(ERRORIN0_N)		F_(0, 0)		FM(TAUD0I14)		FM(TAUD0O14)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_19_16	F_(0, 0)		FM(ERROROUT_C_N)	F_(0, 0)		FM(TAUD0I13)		FM(TAUD0O13)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP1SR4_27_24	F_(0, 0)		FM(ERRORIN1_N)		F_(0, 0)		FM(TAUD0I15)		FM(TAUD0O15)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_31_28	F_(0, 0)		FM(MSPI1CSS3)		F_(0, 0)		FM(TAUD1I1)		FM(TAUD1O1)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP2SR4 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 - F */
#define IP2SR4_3_0	F_(0, 0)		F_(0, 0)		F_(0, 0)		FM(TAUD1I0)		FM(TAUD1O0)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR4_7_4	F_(0, 0)		FM(MSPI1CSS5)		F_(0, 0)		FM(TAUD1I3)		FM(TAUD1O3)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR4_11_8	F_(0, 0)		FM(MSPI1CSS4)		F_(0, 0)		FM(TAUD1I2)		FM(TAUD1O2)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR4_15_12	F_(0, 0)		FM(MSPI1CSS6)		F_(0, 0)		FM(TAUD1I4)		FM(TAUD1O4)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
static unsigned int r8a779f0_pinmux_get_bias(struct sh_pfc *pfc,
					     unsigned int pin)
{
...
static void r8a779f0_pinmux_set_bias(struct sh_pfc *pfc, unsigned int pin,
				     unsigned int bias)
{
	const struct pinmux_bias_reg *reg;
	u32 enable, updown;
...
static const struct sh_pfc_soc_operations pinmux_ops = {
	...
	.get_bias = r8a779f0_pinmux_get_bias,
	.set_bias = r8a779f0_pinmux_set_bias,
};
