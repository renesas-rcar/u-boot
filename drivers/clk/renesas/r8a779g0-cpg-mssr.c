...
static const struct cpg_core_clk r8a779g0_core_clks[] = {
	...
	DEF_FIXED("sasyncperd1", R8A779G0_CLK_SASYNCPERD1, CLK_PLL5_DIV4, 3, 1),
	DEF_FIXED("sasyncperd2", R8A779G0_CLK_SASYNCPERD2, CLK_PLL5_DIV4, 6, 1),
	DEF_FIXED("sasyncperd4", R8A779G0_CLK_SASYNCPERD4, CLK_PLL5_DIV4, 12, 1),
...
static const struct mssr_mod_clk r8a779g0_mod_clks[] = {
	...
	DEF_MOD("scif0",	702,	R8A779G0_CLK_S0D12_PER),
	DEF_MOD("scif1",	703,	R8A779G0_CLK_S0D12_PER),
	DEF_MOD("scif3",	704,	R8A779G0_CLK_S0D12_PER),
	DEF_MOD("scif4",	705,	R8A779G0_CLK_S0D12_PER),
