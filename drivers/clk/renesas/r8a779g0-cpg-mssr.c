...
static const struct cpg_core_clk r8a779g0_core_clks[] = {
	...
	DEF_GEN4_SDH("sdh0",	R8A779G0_CLK_SD0H,	CLK_SDSRC,	   0x870),
	...
	DEF_DIV6P1("post2",	R8A779G0_CLK_POST2,	CLK_PLL5_DIV4,	0x894),
	DEF_DIV6P1("post3",	R8A779G0_CLK_POST3,	CLK_PLL5_DIV4,	0x898),
	DEF_DIV6P1("post4",	R8A779G0_CLK_POST4,	CLK_PLL5_DIV4,	0x89C),
...
static const struct mssr_mod_clk r8a779g0_mod_clks[] = {
	...
	DEF_MOD("scif0",	702,	R8A779G0_CLK_R),
	DEF_MOD("scif1",	703,	R8A779G0_CLK_R),
	DEF_MOD("scif3",	704,	R8A779G0_CLK_R),
	DEF_MOD("scif4",	705,	R8A779G0_CLK_R),
