...
/* SCC registers */
#define RENESAS_SDHI_SCC_DTCNTL			0x980
...
#define RENESAS_SDHI_SCC_TAPSET			0x982
#define RENESAS_SDHI_SCC_DT2FF			0x984
#define RENESAS_SDHI_SCC_CKSEL			0x986
#define   RENESAS_SDHI_SCC_CKSEL_DTSEL			BIT(0)
#define RENESAS_SDHI_SCC_RVSCNTL		0x988
#define   RENESAS_SDHI_SCC_RVSCNTL_RVSEN		BIT(0)
#define RENESAS_SDHI_SCC_RVSREQ			0x98a
#define   RENESAS_SDHI_SCC_RVSREQ_RVSERR		BIT(2)
#define RENESAS_SDHI_SCC_SMPCMP			0x98c
#define RENESAS_SDHI_SCC_TMPPORT2		0x98e
